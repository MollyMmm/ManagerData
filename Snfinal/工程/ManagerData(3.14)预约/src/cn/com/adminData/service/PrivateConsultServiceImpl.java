...
public class PrivateConsultServiceImpl implements PrivateConsultService {
	...
	public Boolean addPrivateConsult(PrivateConsultBean consult,//添加
		...
		//插入的sql
		String sql = "insert into PrivateConsult(id,ExtendedId,Userid,Consulting_Body,Consulting_Time,Deadline,Consulting_Type,Reply_Body,Reply_Time) values(PrivateConsult_seq.nextval,"+ExtendedId+","+UserId+",'"+Consulting_Body+"','"+Consulting_Time+"','"+Deadline+"','"+Consulting_Type+"','"+Reply_Body+"','"+Reply_Time+"')";
	...
	public Boolean deletePrivateConsult(PrivateConsultBean consult,  //删除
		...
		String sql = "delete from PrivateConsult where id="+String.valueOf(id);	
	...
	public Boolean updatePrivateConsult(PrivateConsultBean consult,  //更新操作
		...
		String Reply_Time = consult.getReply_Time();
		//拼接字符串
		String sql = "update PrivateConsult set UserID="+UserId+",ExtendedId="+ExtendedId+",Consulting_Body='"+Consulting_Body+"',Consulting_Time='"+Consulting_Time+"',Deadline='"+Deadline+"',Consulting_Type='"+Consulting_Type+"',Reply_Body='"+Reply_Body+"',Reply_Time='"+Reply_Time+"' where id="+String.valueOf(id);
		System.out.println("-------------"+sql);		
	...
	public PrivateConsultBean selectOne(String id) {    //查询一个数据
		...
		consultM.setConsulting_Body(String.valueOf(consult.get("CONSULTING_BODY")));//存值开始进对象consultM
		consultM.setConsulting_Time(String.valueOf(consult.get("CONSULTING_TIME")));
		consultM.setConsulting_Type(String.valueOf(consult.get("CONSULTING_TYPE")));
		...
		consultM.setReply_Body(String.valueOf
				(consult.get("REPLY_BODY")));
	...
	public PageBean select(String con1, String con2, String con3) {
		...
		String sql = "select * from PrivateConsult where 1=1"+con1+con2+con3;
System.out.println("------"+sql);
