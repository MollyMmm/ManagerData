...
public class NoticeServiceImpl implements Notice{
	...
	public boolean addNotice(NoticeBean notice,HttpSession session) {
		...
		String sql="insert into Notice (id,ExtendedId,Title,Body,MainBody,PublishTime,UpdateTime,Picture,Type) values(Notice_seq.nextval,"+ExtendedId+",'"+Title+"','"+Body+"','"+MainBody+"','"+PublishTime+"','"+UpdateTime+"','"+Picture+"',"+Type+")";
