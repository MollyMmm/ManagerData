...
public class UserService {
	...
	public PageBean listByPage(String currentPage, String user,
		...
		// 判断查询条件的参数
		creatTime = (creatTime == null || creatTime == "") ? "" : (" and createTime = '" + creatTime+ "'"
				);
		...
		realName = (realName == null || realName == "") ? ""
			...
			sex = (sex == null || sex == ""||sex.equals("all")) ? ""
					: (" and sex='" + sex + "'");
		...
		// sql------------
		String sql = "select a.tele,a.username,a.realname,a.sex,a.email,to_char(id) as c_id, createtime as c_t from admininfo a where 1=1" + user + realName
