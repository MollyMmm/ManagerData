...
<%@page import="cn.com.managerData.util.*"%>  
<%!
// 生成随机颜色方法定义 
...
// 获取需要显示在图片上的验证码的字体，可根据字体库中的文件名自定义
//Font f1,f2,f3,f4;
Font f1 = fh.getFont((new Random().nextInt(5)+1)+".ttf");
//f2 = fh.getFont("3.ttf");
//f3 = fh.getFont("4.ttf");
//f4 = fh.getFont("5.TTF");
//Font[] fontTypes = {f1,f2,f3,f4}; 
//Font[] fontTypes = {f1}; 
...
g.setColor(tmpColor); 
// 设置字体 
//g.setFont(fontTypes[random.nextInt(fontTypes.length)]); 
g.setFont(f1); 
for (int i=0;i<4;i++) 
{ 
