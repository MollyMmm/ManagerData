			...
			<div id="mainPanel">
				...
				<div id="right">
					...
					<div id="user-name">
						...
						<span><input type="text" name="UserName" class="form-input" value="请输入账号" style = "color: #999999" 	onfocus="focusTest(this)" ></span>
					</div>
		...
		<div class="div_from_aoto" style="width: 500px;">
			<form action="<%=path%>/LoginServlet" method="post">
				<div class="control-group">
					...
					<div class="controls">
						<input class="input_from" type="text" name="UserName"
							value="请输入账号" style="color: #999999" onfocus="focusTest(this)">
				...
				<%--<div class="control-group">
					...
					<div class="controls">
						<input class="input_from" type=text placeholder=" 请输入确认密码">
						<p class=help-block></p>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<%--
            <button class="btn btn-success" style="width:120px; background-color:orange" >确认</button>
            --%>
