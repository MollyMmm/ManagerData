				...
				<table>
					<tr>
						...
						<td>
							...
							<option value="integral0" <%String sorce0 = "";
if(sorce0.equals("integral0")){
%> selected="selected"<%
}
 %>>全部</option>
				...
				<td align="center" valign="middle">
					...
					<%
							if (list.size() == 0) {
								...
								<%if(request.getAttribute("integral") != null) {%>积分范围：<%if(request.getAttribute("integral").toString()=="integral3"){String str = "400以上";}%>400以上<%}%>
