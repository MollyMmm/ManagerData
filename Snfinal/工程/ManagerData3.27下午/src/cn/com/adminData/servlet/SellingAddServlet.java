...
public class SellingAddServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		sellingM.setSaler_id(request.getParameter("SALER_ID"));
		...
		boolean result = sellingS.addSelling(sellingM, session);
		if (result) {
			//添加成功
			
		//获取添加成功后的id
		String id = sellingS.selectId(sellingM.getTitle(), sellingM.getBody());
