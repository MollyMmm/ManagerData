...
public class SoilMessageServiceImpl implements SoilMessageService{
	...
	public Boolean addSoilMessage(SoilMessageBean message, HttpSession session) {
		...
		"Negotiable_Year,SurplusYear,SoilUsing,Land_Warrants,Type) values(SoilMessage_seq.nextval,"+ExtendedId+",'"+Names+"','"+Picture+"',"+Price+",'"+ConversionProperty+"','"+SoilArea+"','"+NegotiableYear+"','"+SurplusYear+"','"+SoilUsing+"','"+LandWarrants+"','"+Type+"')";
		int operate = 1;
