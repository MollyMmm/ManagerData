			...
			<form action="<%=path%>/NoticeSearchServlet" method="post" >
				<table>
					...
					<td>
						...
						<td>
							<font
								style="font-family: 微软雅黑; font-size: 15px; color: #333333;">标识ID：</font>
							<input type="text" name="leixing1">
						</td>
						<td>
							<font
								style="font-family: 微软雅黑; font-size: 15px; color: #333333;">题目：</font>
							<input type="text" name="leixing2">
						</td>
						<td>
							<font
								style="font-family: 微软雅黑; font-size: 15px; color: #333333;">关键词：</font>
							<input type="text" name="leixing3">
						</td>
						<td>
							<input type="submit" value="搜索">
							<a href="jsp/ordAdmin/notice/addNotice.jsp"><input
				...
				<td align="center" valign="middle">
					...
					<%
						...
						%><tr>
							...
							<td><%if(body.length()>10){%><%=body.substring(0,9)+"..."%><%}%></td>
							<td><%if(mainBody.length()>10){%><%=mainBody.substring(0,9)+"..."%><%}%></td>
							...
							<td>
								...
								<a href="<%=path%>/NoticeDelServlet?ID=<%=notice.get("ID")%>">删除</a>
							</td>
						</tr>
						<%
							}
