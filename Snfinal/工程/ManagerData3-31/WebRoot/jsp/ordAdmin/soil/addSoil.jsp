...
<html>
  <head>
    ...
    <title>My JSP 'addSoil.jsp' starting page</title>
		...
		<table width="100%" height="80%" border="0" cellspacing="0"
			...
			<tr>
				<td align="center" valign="middle">
					<form method="post" action="<%=path%>/SoilAddServlet"  >
						<table class="altrowstable" id="alternatecolor">
							...
							<tr>
								...
								<td>
									<textarea rows="7" cols="20" name="PRODUCTMESSAGE"></textarea>
								</td>
							</tr>
								<tr>
								...
								<td>
									<textarea rows="3" cols="20" name="TRADELOCATION"></textarea>
								</td>
							</tr>
							<tr>
								<td>
