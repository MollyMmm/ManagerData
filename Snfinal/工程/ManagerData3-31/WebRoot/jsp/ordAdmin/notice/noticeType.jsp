...
<html>
  <head>
    ...
    <title>My JSP 'noticeType.jsp' starting page</title>
...
function deleteDialog(id){
	...
	<%--增加--%>
		function addType(){
			 art.dialog.open('<%=path%>/jsp/ordAdmin/notice/noticeTypeAdd.jsp', {
				title: '添加公告类型',
				time:1200,
				 //遮罩层
			    lock:true,
		...
		<table>
			...
			<%
						...
						%><tr>
							...
							<td>
								<!--  <a
									href="<%=path%>/NoticeSelOneServlet?id=<%=type.get("ID")%>">编辑</a>-->
						...
						%>
						<tr><td colspan="3">
						<input type="button" value="添加其他公告类型"  onclick="addType();"/>
						</td></tr>
		</table>
	</body>
</html>
