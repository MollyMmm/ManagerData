...
public class SellingGoodsServiceImpl implements SellingGoods{
	...
	public boolean addSellingGoods(SellingGoodsBean sellingGoods,
		...
		String sql = "insert into sellinggoods(id,extendedid,title,product_message,trade_location,publish_time,update_time,saler_id,saler_name,contact_method,valid_date,isvalid) values(sellinggoods_seq.nextval,"+sellingGoods.getExtendedid()+
...
System.out.println("------------------------"+sql);
	...
	public boolean deleteSellingGoods(SellingGoodsBean sellingGoods,
		...
		String sql = "delete from sellingGoods where id="+String.valueOf(id);
		int operator = 2;
		return dao.update(sql, operator, session);
	}
	...
	public PageBean select(String con1, String con2, String con3,
			String currentPage) {
		String sql = "select * from sellinggoods where 1=1 "+con1+con2+con3;
		System.out.println("------"+sql);
...
SellingGoodsBean sellinggoodsN=new SellingGoodsBean();
	...
	public boolean updateSellingGoodse(SellingGoodsBean sellingGoods,
		...
		String sql = "update sellinggoods set extendedid="+sellingGoods.getExtendedid()+",ISVALID='"+sellingGoods.getIsvalid()+"',"+
