			...
			<form action="<%=path%>/GoodsMessageSearchServlet" method="post">
				<table>
					...
					<td>
						...
						<td>
							<font
								style="font-family: 微软雅黑; color: #333333;">商铺名：</font>
							<input type="text" name="leixing2">
						</td>
						<td>
							<font
								style="font-family: 微软雅黑; color: #333333;">商铺描述：</font>
				...
				<td align="center" valign="middle">
					...
					<%
							if (list.size() == 0) {
								...
								<%if(request.getAttribute("leixing2") != null) {%>商铺名：<%=request.getAttribute("leixing2")%><%}%>
								<%if(request.getAttribute("leixing3") != null) {%>商铺描述：<%=request.getAttribute("leixing3")%><%}%>
								信息不存在，如需创建，请点击创建按钮！
								</td>
								</tr>
						...
						%><tr>
							...
							<td><%=GoodsMessage.get("ADDRESS")%></td>
