...
public class ExpertMessageDeleteServlet extends HttpServlet {
	...
	throws ServletException, IOException {
		...
		if(bool){
			request.getRequestDispatcher("/jsp/ordAdmin/expertMessage/deleteSucc.jsp").forward(request, response);
		}
		else{
			request.getRequestDispatcher("/jsp/ordAdmin/expertMessage/deleteFail.jsp");
		}
