...
public class NoticeShowServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String sql = "select n. id,n.EXTENDEDID,n.EDITOR,n.TITLE,n.BODY,n.MAINBODY,n.PUBLISHTIME,N.UPDATETIME,N.PICTURE,N.TYPE,nt.typename from Notice n,NoticeType nt where n.type=nt.id order by N.UPDATETIME";
		if (request.getParameter("currentPage") != null) {
			...
			// 查询所有用户信息 list 参数sql
			pageBean.setSql(sql);
			int count = jdbc.getCount(sql,null);
