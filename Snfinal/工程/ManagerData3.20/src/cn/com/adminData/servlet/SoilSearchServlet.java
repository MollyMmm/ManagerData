...
public class SoilSearchServlet extends HttpServlet {
...
String BODY = request.getParameter("leixing3")==""||request.getParameter("leixing3")==null?"":" and PRODUCTMESSAGE like '%"+request.getParameter("leixing3")+"%'";
