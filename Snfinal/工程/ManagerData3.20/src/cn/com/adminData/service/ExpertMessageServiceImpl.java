...
public class ExpertMessageServiceImpl implements ExpertMessageService{
	...
	public Boolean addExpertMessage(ExpertMessageBean message,
		...
		String sql = "insert into ExpertMessage(id,ExtendedId,Names,Head_Portrait,Birth,Major,DutyTime,info) values(SoilMessage_seq.nextval,"+ExtendedId+",'"+Names+"','"+Head_Portrait+"','"+Birth+"','"+Major+"','"+DutyTime+"','"+Info+"')";
		int operate = 1;
	...
	public ExpertMessageBean selectOne(String id) {
		...
		ExpertMessageN.setInfo(String.valueOf(ExpertMessage.get("INFO")));
	...
	public Boolean updateMessageService(ExpertMessageBean message,
		...
		String sql="update ExpertMessage set ExtendedId="+ExtendedId+",Names='"+Names+"',Head_Portrait='"+Head_Portrait+"',Birth='"+Birth+"',Major='"+Major+"',DutyTime='"+DutyTime+"',Info='"+Info+"' where id="+String.valueOf(id);
System.out.println("-------------"+sql);		
	...
	public String selectId(String name, String info) {
	String sql = "select id from ExpertMessage where names='"+name+"' and info ='"+info+"'";
