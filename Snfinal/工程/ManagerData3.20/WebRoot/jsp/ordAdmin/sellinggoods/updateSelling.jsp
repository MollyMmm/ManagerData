...
SellingGoodsBean sellingN = (SellingGoodsBean)request.getAttribute("selling");
%>
...
<html>
  <head>
    ...
    <title>My JSP 'updateSelling.jsp' starting page</title>
		...
		<table width="100%" height="80%" border="0" cellspacing="0"
			...
			<tr>
				<td align="center" valign="middle">
					<form action="<%=path%>/SellingUpServlet" method="post">
						...
						<tr>
							...
							onfocus="WdatePicker({skin:'whyGreen',minDate:'%y-%M-%d'})"
							 size="16"  name="VALID_DATE" value="<%=sellingN.getValid_date()%>"/>
