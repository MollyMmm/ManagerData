	...
	<body>
			...
			<ul id="menu">
				<li class="childUlLi">
					...
					<!--<li>
						...
						<li>
							<a href="<%=path%>/SellingServlet" target="menuFrame"><i
								class="glyph-icon icon-chevron-right"></i>农资采购</a>
						</li>
							<li>
							<a href="<%=path%>/FarmingServlet" target="menuFrame"><i
								class="glyph-icon icon-chevron-right"></i>农事提醒</a>
						</li>
							<li>
							<a href="<%=path%>/NewsServlet" target="menuFrame"><i
				...
				<li class="childUlLi">
					...
					<ul>
						...
						<li>
							<a href="<%=path%>/SoilServlet" target="menuFrame"><i
					...
					<!-- 	<li>
						...
						<li>
							<a href="<%=path %>/SuplyServlet" target="menuFrame"><i
								class="glyph-icon icon-chevron-right"></i> 供求信息</a>
						</li>
						
						<li>
							<a href="<%=path%>/TechnicalServlet" target="menuFrame"><i
		...
		<div id="layout_right_content" class="layout_right_content">
			...
			<div class="mian_content">
				<div id="page_content">
					<iframe id="menuFrame" name="menuFrame" src="<%=path%>/NoticeShowServlet"
